...
mv codecvt typeindex type_traits chrono initializer_list tuple scoped_allocator cstdint cinttypes system_error cuchar random ratio cfenv regex atomic thread mutex shared_mutex future condition_variable ccomplex ctgmath cstdalign cstdbool ../sorted/cpp11
mv cassert bitset cctype cerrno cfloat ciso646 climits clocale cmath complex csetjmp csignal cstdarg cstddef cstdio cstdlib cstring ctime cwchar cwctype dynarray ../sorted/cpp
