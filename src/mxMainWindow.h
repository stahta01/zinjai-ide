...
//	wxTextCtrl* toolbar_find_text;
	...
	void OnSelectErrorCommon(const wxString &error, const wxString &first_child, bool set_focus_timer=false); ///< to be called from OnExternCompilerOutput y OnSelectError
